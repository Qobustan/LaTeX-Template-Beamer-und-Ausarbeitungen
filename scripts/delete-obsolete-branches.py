#!/usr/bin/env python3
"""
Script to delete obsolete branches from a GitHub repository.
...
Usage:
    python3 delete-obsolete-branches.py
    python3 delete-obsolete-branches.py --dry-run
"""
...
# Branches to keep (always preserved)
BRANCHES_TO_KEEP = [
    "main",
    # Add any currently-open PR branches here:
    # "copilot/my-active-branch",
]

# Obsolete branches to delete – update this list before running
# List verified as of: 2026-03-01
OBSOLETE_BRANCHES: List[str] = [
    # Example (uncomment or replace with your actual obsolete branches):
    # "feature/old-feature",
