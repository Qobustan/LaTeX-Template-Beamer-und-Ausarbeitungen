...
% kann zu Konflikten führen. fontspec liefert volle Unicode-Unterstützung.
% pdflatex benötigt inputenc, um UTF-8-kodierte Quelldateien korrekt zu verarbeiten.
\usepackage{iftex}
\ifluatex
  \usepackage{fontspec}
...
% ANLEITUNG: Ersetzen Sie den folgenden Inhalt mit Ihrer eigenen Ausarbeitung.
