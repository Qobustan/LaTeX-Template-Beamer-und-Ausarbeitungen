% ==============================================================================
% header.tex  (Besprechung/Material/Vortrag)
% Standalone-Header für Besprechungsmaterial (kein Split-Aufbau)
%
% BEREINIGUNGSPROTOKOLL (Überarbeitung 2026):
%   - natbib         → Entfernt: war nur auskommentiert und ist inkompatibel
%                      mit biblatex (dem hier genutzten Literaturpaket)
%   - ucs            → Entfernt: \usepackage[mathletters]{ucs} war auskommentiert
%                      und ist inkompatibel mit biblatex
%   - cite           → Entfernt: war auskommentiert und ist inkompatibel mit biblatex
%   - bibtex         → Entfernt: \usepackage{bibtex} existiert nicht als Paket;
%                      war auskommentierter Tippfehler (bibtex ist ein Programm)
%   - \bibliographystyle → Entfernt: Gilt nur für bibtex-Workflow; dieses Template
%                          nutzt biblatex mit \printbibliography
%   - tipa           → Entfernt: Das Paket liefert phonetische IPA-Symbole und
%                      definiert viele Text-Befehle um, was zu Konflikten mit
%                      anderen Schriftpaketen (lmodern, fontspec) führt.
%                      tipa wird in diesem Template nirgends verwendet.
%   - amssymb (2×)   → Dedupliziert: Doppeltes \usepackage{amssymb} ist
%                      harmlos, aber verwirrend; zweiten Aufruf entfernt
%   - xcolor (2×)    → Dedupliziert: wie amssymb
%   - amsthm (2×)    → Dedupliziert: wie amssymb
%   - hyperref (2×)  → Dedupliziert: wie amssymb; doppeltes hyperref kann
%                      außerdem Warnungen erzeugen
%   - \newtheorem{theorem} HINZUGEFÜGT (Bugfix): Alle Umgebungen nutzten
%                      [theorem] als Counter-Referenz, aber \newtheorem{theorem}
%                      war nie definiert → Laufzeitfehler behoben
%
% ==============================================================================
...
% Mathematische Symbole (Doppelstrich-Schrift)
\usepackage{dsfont}

% Mathematische Symbole (AMS-Erweiterung)
\usepackage{amssymb}
...
% ANLEITUNG: Passen Sie diese Metadaten für Ihr Projekt an
\author{Your Name}
