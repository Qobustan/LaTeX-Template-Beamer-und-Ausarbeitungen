...
%   Diese Datei enthält primär \usepackage-Aufrufe, die sowohl mit dem
%   Beamer-Dokumentenstil (Vortrag/) als auch mit scrartcl (Ausarbeitung/) sicher
%   kompatibel sind, sowie ggf. eine kleine Menge bewusst ausgewählter,
%   klassenunabhängiger Konfiguration (z.B. \usetikzlibrary, \pgfplotsset).
%
%   Umfangreiche oder klassen-/theme-spezifische Konfigurationsbefehle
%   (\definecolor, \hypersetup, \setlist, \newtheorem, \tikzset, \newcommand,
%   \lstset usw.) dürfen NICHT hier stehen, weil Beamer viele davon intern
%   bereits setzt; doppelte Definitionen erzeugen Konflikte oder überschreiben
%   das Beamer-Theme stillschweigend.
%   → Solche Befehle gehören in header-article.tex (Ausarbeitung) bzw. in das
%     Beamer-Theme / header-beamer.tex (Vortrag).
%
...
% header-beamer.tex (Vortrag-Kontext).
%
% Grund: \lstset verwendet \color{codeblue} für keywordstyle. Die Farbe
% codeblue wird erst in header-beamer.tex per \definecolor definiert.
% Würde \lstset hier stehen, käme es zu einem „Undefined color `codeblue'"
% -Fehler, weil header-common.tex vor header-beamer.tex eingelesen wird.
% (Analoges gilt für header-article.tex im Ausarbeitung-Kontext.)
\usepackage{listings}
