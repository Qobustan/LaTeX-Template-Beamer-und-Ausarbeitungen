...
% LuaLaTeX verarbeitet UTF-8 nativ – inputenc ist hier nicht erforderlich und
% kann zu Konflikten führen. Das iftex-Paket ist bereits in header-beamer.tex geladen.
\ifluatex\else
...
% ANLEITUNG: Literaturverwaltung mit biblatex/biber
% Diese Vorlage verwendet biblatex mit backend=biber. Kompilieren Sie daher NICHT mit bibtex,
% sondern mit biber, z.B. in der Kommandozeile:
%   lualatex Vortrag
%   biber Vortrag
%   lualatex Vortrag
%   lualatex Vortrag
% (Bei Verwendung von pdflatex/latex entsprechend anpassen.)
